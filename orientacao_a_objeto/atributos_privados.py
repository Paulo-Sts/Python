# Em python todos os atributos são públicos, mas para informar que eles não devem ser acessados diretamente usa-se dois __(underscore) na definição do atributo.
class Celular:
